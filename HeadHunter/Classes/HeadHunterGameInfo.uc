...
// DeathMatchPlus.
//=============================================================================
class HeadHunterGameInfo extends TournamentGameInfo
	config;
...
var() config float SkullCollectTimeInterval;//how often are skulls collected to be scored
//var float LastTimeSkullsCollected;//time that the skulls were last collected, to
