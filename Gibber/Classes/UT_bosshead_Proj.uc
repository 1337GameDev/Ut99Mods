//=============================================================================
// UT_bosshead used as a Projectile.
//=============================================================================
class UT_bosshead_Proj extends ut_bosshead;
...
function Destroyed(){
	Super.Destroyed();
	if(Self.Inventory != None){//if we had a GibberProjectileContext, make sure it's destroyed too
