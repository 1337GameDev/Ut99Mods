...
// TestMatchPlus.
//=============================================================================
class TestMatchPlus extends TournamentGameInfo
	config;
...
function AcceptInventory(pawn PlayerPawn)
{
	...
	// TestMatchPlus accepts LadderInventory
...
defaultproperties {
      ...
      PlayerRating=0.000000
      AvgOpponentRating=0.000000
      NumOpp=0
      WinCount=0
      LoseCount=0
      RatedPlayer=None
      IDnum=0
      RatedMatchConfig=None
      EndTime=0.000000
      LadderTypeIndex=1
      RatedGameLadderObj=None
      bNoMonsters=True
      bHumansOnly=False
      bRestartLevel=False
      bPauseable=False
      ...
      MapPrefix="DM"
      BeaconName="DM"
      GameName="Testing Match"
      DeathMessageClass=Class'LGDUtilities.TestMessagePlus'
      DMMessageClass=Class'LGDUtilities.TestMatchMessage'
