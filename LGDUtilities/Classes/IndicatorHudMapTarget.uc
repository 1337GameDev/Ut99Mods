//-----------------------------------------------------------
// An actor that sets another actor to be an indicator hud target.
...
function PreBeginPlay() {
    ...
    if(self.TargetForIndicator == None){
        ...
        targetsFromPrams = new class'LGDUtilities.LinkedList';
        targetsFromPrams.Push(self.TargetForIndicator);
    }

    fn = new class'LGDUtilities.IndicatorHudMapTargetModifierFn';
    fn.IndicatorVisibleToTeamNum = IndicatorVisibleToTeamNum;
    fn.ShowIndicatorToHudOwnerTeamNum = ShowIndicatorToHudOwnerTeamNum;

    targets = new class'LGDUtilities.LinkedList';

    while(targetsFromPrams.Count > 0){
        listElementFromParams = targetsFromPrams.Pop();

        hudTargetListElement = new class'LGDUtilities.IndicatorHudTargetListElement';
		hudTargetListElement.IndicatorSource = self;
    ...
    hudTargetMutCallback = new class'LGDUtilities.IndicatorHudMapTargetHUDMutator';
    ...
    class'LGDUtilities.PlayerSpawnMutator'.static.RegisterToPlayerSpawn(self, hudTargetMutCallback);
}
...
function LinkedList GetTargetsFromParams(){
     ...
     targetsFound = new class'LGDUtilities.LinkedList';
