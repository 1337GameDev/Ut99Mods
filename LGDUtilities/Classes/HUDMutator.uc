...
function Mutator GetThisHUDMutatorFromAnyPlayerPawn(){
    return class'LGDUtilities.HUDMutator'.static.GetHUDMutatorFromAnyPlayerPawnByClass(self, self.Class);
}
static function Mutator GetHUDMutatorFromAnyPlayerPawnByClass(Actor context, class<Mutator> mutClass){
    ...
    ForEach context.AllActors(class'PlayerPawn', P) {
        if (P.myHUD != None) {
            return class'LGDUtilities.HUDMutator'.static.GetHUDMutatorFromPlayerPawnByClass(P, mutClass);
        }
    }
